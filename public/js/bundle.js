...
var navAccountLinks = document.querySelectorAll('.user-view__menu > .side-nav li');
...
if (formReview) {
  formReview.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
      var data, review, rating, btnSend, btnUpdate, btnCreateUpdate, tourId;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            e.preventDefault();
            ...
            btnUpdate = formReview.querySelector('.btn__update');
...
if (navAccountLinks) {
  ...
  navAccountLinks.forEach(function (link, i) {
    if (i === index) {
